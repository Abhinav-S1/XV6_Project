...
int main(int argc, char *argv[]) {
  ...
  if(argc < 2)
  1d:	83 39 01             	cmpl   $0x1,(%ecx)
int main(int argc, char *argv[]) {
  20:	8b 41 04             	mov    0x4(%ecx),%eax
  if(argc < 2)
  23:	7f 60                	jg     85 <main+0x85>
  if (n < 0 ||n > 20)
	n = 2;
  x = 0;
  pid = 0;
  ...
  30:	74 6f                	je     a1 <main+0xa1>
      // parent
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  32:	e8 bc 03 00 00       	call   3f3 <getpid>
  37:	53                   	push   %ebx
  for ( k = 0; k < n; k++ ) {
  38:	83 c6 01             	add    $0x1,%esi
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  3b:	50                   	push   %eax
  3c:	68 6c 08 00 00       	push   $0x86c
  41:	6a 01                	push   $0x1
  43:	e8 a8 04 00 00       	call   4f0 <printf>
      wait();
  48:	e8 2e 03 00 00       	call   37b <wait>
  4d:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  50:	39 fe                	cmp    %edi,%esi
  52:	7d 2c                	jge    80 <main+0x80>
    pid = fork ();
  54:	e8 12 03 00 00       	call   36b <fork>
  59:	89 c3                	mov    %eax,%ebx
    if ( pid < 0 ) {
  5b:	85 c0                	test   %eax,%eax
  5d:	79 d1                	jns    30 <main+0x30>
      printf(1, "%d failed in fork!\n", getpid());
  5f:	e8 8f 03 00 00       	call   3f3 <getpid>
  64:	83 ec 04             	sub    $0x4,%esp
  for ( k = 0; k < n; k++ ) {
  67:	83 c6 01             	add    $0x1,%esi
      printf(1, "%d failed in fork!\n", getpid());
  6a:	50                   	push   %eax
  6b:	68 58 08 00 00       	push   $0x858
  70:	6a 01                	push   $0x1
  72:	e8 79 04 00 00       	call   4f0 <printf>
  77:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  7a:	39 fe                	cmp    %edi,%esi
  7c:	7c d6                	jl     54 <main+0x54>
  7e:	66 90                	xchg   %ax,%ax
  ...
  exit();
  80:	e8 ee 02 00 00       	call   373 <exit>
	n = atoi(argv[1]);
  85:	83 ec 0c             	sub    $0xc,%esp
  88:	ff 70 04             	pushl  0x4(%eax)
  8b:	e8 70 02 00 00       	call   300 <atoi>
  if (n < 0 ||n > 20)
  ...
  9f:	eb 84                	jmp    25 <main+0x25>
      char *arr=malloc(4096*25);
  a1:	83 ec 0c             	sub    $0xc,%esp
  a4:	68 00 90 01 00       	push   $0x19000
  a9:	e8 a2 06 00 00       	call   750 <malloc>
      arr[1]='a';
  ae:	c6 40 01 61          	movb   $0x61,0x1(%eax)
      char *arr=malloc(4096*25);
  ...
  bc:	50                   	push   %eax
  bd:	68 89 08 00 00       	push   $0x889
  c2:	6a 01                	push   $0x1
  c4:	e8 27 04 00 00       	call   4f0 <printf>
	for(t = 0; t < 25; t++)
  c9:	8d 43 01             	lea    0x1(%ebx),%eax
  cc:	8d 93 01 90 01 00    	lea    0x19001(%ebx),%edx
  d2:	83 c4 10             	add    $0x10,%esp
  d5:	8d 76 00             	lea    0x0(%esi),%esi
	    arr[t*4096+1]='a';
  d8:	c6 00 61             	movb   $0x61,(%eax)
	    for(z = 0; z < 70000000; z+=1)
  db:	d9 ee                	fldz   
  dd:	8d 76 00             	lea    0x0(%esi),%esi
  e0:	d8 05 9c 08 00 00    	fadds  0x89c
  e6:	d9 05 a0 08 00 00    	flds   0x8a0
  ec:	df f1                	fcomip %st(1),%st
  ee:	77 f0                	ja     e0 <main+0xe0>
  f0:	dd d8                	fstp   %st(0)
	for(t = 0; t < 25; t++)
  f2:	05 00 10 00 00       	add    $0x1000,%eax
  f7:	39 d0                	cmp    %edx,%eax
  f9:	75 dd                	jne    d8 <main+0xd8>
  fb:	eb 83                	jmp    80 <main+0x80>
  for ( k = 0; k < n; k++ ) {
  fd:	85 c0                	test   %eax,%eax
  ff:	0f 85 20 ff ff ff    	jne    25 <main+0x25>
 105:	e9 76 ff ff ff       	jmp    80 <main+0x80>
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb a4 08 00 00       	mov    $0x8a4,%ebx
        while(*s != 0){
